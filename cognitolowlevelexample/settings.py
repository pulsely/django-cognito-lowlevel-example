"""
Django settings for cognitolowlevelexample project.
...
SECRET_KEY = 'django-insecure-grbq)@z0-!*47j4x@f^%k7@xo1x_26zopaypj^ph=vjy9zsw&z'
...
ROOT_URLCONF = 'cognitolowlevelexample.urls'
...
WSGI_APPLICATION = 'cognitolowlevelexample.wsgi.application'
...
##### Now, configure these variables as described at: https://github.com/pulsely/django-cognito-lowlevel
# COGNITO_USER_POOL_ID = "eu-west-2XXXXXXXXXXXXXXXXXX"
